...
Java_com_example_laiyang_nest_taskEnum_carPlate_oldPlate_PlateRecognition_InitPlateRecognizer(
...
Java_com_example_laiyang_nest_taskEnum_carPlate_oldPlate_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_example_laiyang_nest_taskEnum_carPlate_oldPlate_PlateRecognition_ReleasePlateRecognizer(
        JNIEnv *env, jobject obj,
        jlong object_re) {
